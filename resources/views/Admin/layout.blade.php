            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        <li>
                            <a href="{{ url('backend/quanlymau') }}"><i class="fa fa-dashboard fa-fw"></i> Quản lý mẫu</a>
                        </li>                        
                        <li>
                            <a href="{{ url('backend/nhan') }}"><i class="fa fa-table fa-fw"></i>Quản lý nhãn</a>
                        </li>
                        <li>
                            <a href="{{ url('backend/quanlymohinh') }}"><i class="fa fa-edit fa-fw"></i>Quản lý mô hình</a>
                        </li>
